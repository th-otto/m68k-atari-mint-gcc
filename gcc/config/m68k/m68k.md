...
;; On 68000/68010, shifts have a 2-cycle per count penalty, so
;; "add.x %0,%0" (4/4/8 cycles for b/w/l) is faster than
;; "lsl.x #1,%0" (8/8/10 cycles for b/w/l).
;; Convert shift-by-1 to add when it's beneficial.

(define_peephole2
  [(set (match_operand:QI 0 "register_operand" "")
	(ashift:QI (match_operand:QI 1 "register_operand" "")
		   (const_int 1)))]
  "TUNE_68000_10 && REGNO (operands[0]) == REGNO (operands[1])"
